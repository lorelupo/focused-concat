...
# bash sh/run_transformer_wmt14_iwslt16_fr.sh --t=train --src=en --tgt=fr --save_dir=en2fr_iwslt16_wmt14_han/k0 --data_dir=wmt14
for argument in "$@" 
do
...
then
    ...
    --finetune-from-model checkpoints/en2fr_wmt14_transformer \
    --optimizer adam \
