#!/bin/bash
# bash sh/run/en-de/iwslt17/transfo_base.sh --t=finetune --save_dir=standard/power_k0 --cuda=1 --pretrained=checkpoints/en-de/wmt14/transfo_base/checkpoint.avg10.pt
# bash sh/run/en-de/iwslt17/transfo_base.sh --t=finetune --save_dir=split/k0 --cuda=0 --pretrained=checkpoints/en-de/wmt14/transfo_base/checkpoint.avg10.pt --data_dir=data/data-bin/iwslt17/split
# bash sh/run/en-de/iwslt17/transfo_base.sh --t=test --save_dir=standard/k0 --cuda=0 --data_dir=data/data-bin/wmt14/test_suites/large_pronoun/k3 --testlog=test_pronoun
# bash sh/run/en-de/iwslt17/transfo_base.sh --t=finetune --cuda=1  --save_dir=fromsplit/k0 --pretrained=checkpoints/iwslt17/split/k0/checkpoint_best.pt
...
then
    ...
    do
    bash $this_script --t=test --save_dir=$save_dir --t=test --cuda=$cuda --lenpen=$l --gen_subset=valid --testlog=valid_bleu_lenpen$l --scored_checkpoint=$scored_checkpoint 
    # gather results
