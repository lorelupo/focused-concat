#!/bin/bash
# bash sh/run/en-de/wmt17/transfo_base.sh --t=train --save_dir=transfo_base
...
then
    ...
    --lr 0.0007 --warmup-init-lr 1e-07 \
...
then
    python scripts/average_checkpoints.py \
        ...
        --output $save_dir/checkpoint.avg_last10.pt
###############################################################################
else
