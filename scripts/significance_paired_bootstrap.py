...
def eval_with_paired_bootstrap(gold, sys1, sys2,
  ...
  sys1_scores.sort()
  sys2_scores.sort()
  print('sys1 mean=%.2f, median=%.2f, 95%% confidence interval=[%.2f, %.2f]' %
          (np.mean(sys1_scores)*100, np.median(sys1_scores)*100, sys1_scores[int(num_samples * 0.025)]*100, sys1_scores[int(num_samples * 0.975)]*100))
  print('sys2 mean=%.2f, median=%.2f, 95%% confidence interval=[%.2f, %.2f]' %
          (np.mean(sys2_scores)*100, np.median(sys2_scores)*100, sys2_scores[int(num_samples * 0.025)]*100, sys2_scores[int(num_samples * 0.975)]*100))
