#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Author: Lena Voita, Anonymous Author
...
parser.add_argument('--results-file', '-rf', metavar='PATH',
...
def evaluate(repo_dir, testset_name, scores_fname, results_file):
...
if __name__ == "__main__":
    ...
    result = evaluate(args.repo_dir, args.test, args.scores, args.results_file)
